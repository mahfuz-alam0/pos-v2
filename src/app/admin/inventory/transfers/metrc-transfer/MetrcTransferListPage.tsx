...
export default function MetrcTransferListPage() {
  ...
  const openRow = (id: string) => {
    ...
    params.set("id", id);
    router.push(`/admin/inventory/transfers/metrc-transfer?${params.toString()}`, { scroll: false });
  };

  const closeDetail = () => {
    const params = new URLSearchParams(searchParams.toString());
    params.delete("id");
    router.push(`/admin/inventory/transfers/metrc-transfer${params.toString() ? `?${params}` : ""}`, { scroll: false });
  };
