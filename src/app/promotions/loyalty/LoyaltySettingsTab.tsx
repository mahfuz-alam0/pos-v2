...
export default function LoyaltySettingsTab() {
  ...
  return (
    <div className="flex flex-col gap-5">
      <div className="flex items-center justify-between rounded-xl p-4 ring-1 ring-foreground/10">
        <div>
      ...
      <div className="grid grid-cols-1 gap-4 lg:grid-cols-2">
        <section className="flex flex-col gap-4 rounded-xl p-4 ring-1 ring-foreground/10">
          <h3 className="text-sm font-semibold">Point Conversion</h3>
        ...
        <section className="flex flex-col gap-4 rounded-xl p-4 ring-1 ring-foreground/10">
          <h3 className="text-sm font-semibold">Earning Strategy</h3>
        ...
        <section className="flex flex-col gap-4 rounded-xl p-4 ring-1 ring-foreground/10">
          <h3 className="text-sm font-semibold">Allow Stacking With</h3>
        ...
        <section className="flex flex-col gap-4 rounded-xl p-4 ring-1 ring-foreground/10">
          <h3 className="text-sm font-semibold">Contact Requirements to Redeem Points</h3>
          <div className="flex flex-wrap gap-4">
